						...
						<form action="controller" method="POST" class="form-container">
							...
							<div class="mb-3">
								...
								<input type="email"
									...
									<div class="mb-3">
								 <input type="text"
									class="form-control" name="name" required placeholder="Name">
									</div>
									<div class="mb-3">
								<input type="text"
									class="form-control" name="surname" required placeholder="Surname">
									</div>
									<div class="mb-3">
								<input type="phone"
									class="form-control" name="phone" required placeholder="Phone">
									</div>
									<div class="mb-3">
